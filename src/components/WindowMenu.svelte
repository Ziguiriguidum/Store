...
<div on:mousedown={() => appWindow.startDragging()} class="h-6 select-none flex justify-end fixed top-0 right-0 left-0 bg-black bg-opacity-50 border-b border-white border-opacity-30">
